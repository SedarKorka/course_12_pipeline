...
# Load the dataset
# Define the URL of the edge list file for the Facebook-Ego network
url_facebook = input('Enter the Facebook URL (or press Enter to use the default):\n')
if not url_facebook:
    url_facebook = os.getenv('FACEBOOK_URL', "https://raw.githubusercontent.com/wang422003/Complex-Networks_exercise/main/Datasets/Group3/Facebook-Ego/348.edges")
...
url_twitter = input('Enter the Twitter URL (or press Enter to use the default):\n')
if not url_twitter:
    url_twitter = os.getenv('TWITTER_URL', "https://raw.githubusercontent.com/wang422003/Complex-Networks_exercise/main/Datasets/Group3/Twitter-Ego/789071.edges")
